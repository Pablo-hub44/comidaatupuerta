...
//
//     final authErrorDecodable = authErrorDecodableFromMap(jsonString);
  ...
  factory AuthErrorDecodable.fromMap(Map<String, dynamic> json) =>
      AuthErrorDecodable(
        error: json["error"] == null
            ? null
            : AuthErrorDecodableError.fromMap(json["error"]),
      );
...
class AuthErrorDecodableError {
  ...
  factory AuthErrorDecodableError.fromJson(String str) =>
      AuthErrorDecodableError.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory AuthErrorDecodableError.fromMap(Map<String, dynamic> json) =>
      AuthErrorDecodableError(
